#ifndef MYALGORITHMPROACTIVE_H
#define MYALGORITHMPROACTIVE_H
...
class MyAlgorithmProactive
{
public:
  MyAlgorithmProactive ();

  virtual ~MyAlgorithmProactive();
