...
*/
class traffic_gen_application : public Application 
{
public:
  /**
  ...
  traffic_gen_application ();

  virtual ~traffic_gen_application();
  ...
  */
  ...
  // void set_path (std::vector<int> p); // set the routing path in the header.

  void set_requestTag (requestTag rt);
...
private:
  ...
  requestTag      m_rt;    // the routing path for the chain
