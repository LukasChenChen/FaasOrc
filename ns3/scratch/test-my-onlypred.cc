...
#include "ns3/myAlgorithm-onlypred.h"



using namespace ns3;

NS_LOG_COMPONENT_DEFINE ("test-my-onlypred");
...
main (int argc, char *argv[])
{
   ...
   LogComponentEnable ("MyAlgorithmOnlypred", LOG_LEVEL_ERROR);
